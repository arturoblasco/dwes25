...
<div style="text-align: center;"><figure><img src="../../img/ut11/get_json.png" alt="get_json" style="zoom:70%; border: 2px solid #fff2c9;" /><figcaption style="font-size: 13px; color: #bd8f04;">Acceso al método index desde la URL api/libros desde el navegador web.</figcaption></figure></div>
