1. Los Planos de la Base de Datos: Migraciones y Estructura en Laravel | Introducción a Laravel


# 1. Los Planos de la Base de Datos: Migraciones y Estructura en Laravel
...
## 1.1. Conceptos Fundamentales de Bases de Datos Relacionales
...
### 1.1.1. ¿Qué es una Base de Datos Relacional?
...
## 1.2. Sistema de Migraciones de Laravel

### 1.2.1. ¿Qué son las Migraciones?
...
## 1.3. Creando Migraciones

### 1.3.1. Comando para Crear Migraciones
...
### 1.3.2. Migración para Crear Tabla
...
### 1.3.3. Tipos de Columnas Comunes
...
### 1.4.2. Tabla Pivote para Relaciones Muchos a Muchos
