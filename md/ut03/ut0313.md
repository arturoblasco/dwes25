...
B) **Cualificado**: Usa una ruta relativa dentro del mismo namespace o subnamespace (`rutaRelativa\recurso`)→ no hace falta poner el *namespace* completo.
...
???examplephp "Ejemplo de organización de archivos"
    ```sh
    /index.php
