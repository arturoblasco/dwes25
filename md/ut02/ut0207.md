...
En el ejemplo anterior, **`/`**es el **delimitador** , *prueba* es el **patrón** que se está buscando e **`i`**es un **modificador** que hace que la búsqueda no distinga entre mayúsculas y minúsculas.
