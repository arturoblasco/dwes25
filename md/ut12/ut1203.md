...
<div style="text-align: center;"><figure><img src="../../img/ut12/peticion_token01.png" alt="peticion_token01" style="zoom:90%; border: 2px solid #fff2c9;" /><figcaption style="font-size: 13px; color: #bd8f04;">Prueba de autenticación basada en tokens (con Thunder Client)</figcaption></figure></div>
