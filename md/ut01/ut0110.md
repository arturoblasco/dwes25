...
* **Estructura del proyecto**:`<br />`
  ``bash         proyecto1/         │         ├── docker-compose.yml         └── src/	# Carpeta del proyecto         ``
...
networks:
webnet:
driver: bridge``				     === "Nginx y PHP"         * **Estructura del proyecto**:<br />         ``bash
proyecto2/
│
├── docker-compose.yml
├── .docker
...
``* **Fichero `docker-compose.yml`**:<br />``yaml
version: '3.8'
...
=== "Php"
``Php     <!DOCTYPE html>     <html lang="es">     <head>         <meta charset="UTF-8">         <meta name="viewport" content="width=device-width, initial-scale=1.0">         <title>Hola Mundo</title>     </head>     <body>         <?php             echo "Hola Mundo";         ?>     </body>     </html>     ``
=== "Resultado"
