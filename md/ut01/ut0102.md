...
???example "Ejemplo con DevTools"
    **Peticiones desde el navegador**
    ...
    === "Paso 2"
        ...
        - [whois](https://who.is/dns/upv.es){target=_blank rel="noopener noreferrer"}: nos indica, entre otros datos, que la IP del servidor es 158.42.4.23 (registro DNS de tipo A).
