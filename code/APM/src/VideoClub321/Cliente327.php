...
class Cliente {
    ...
    public function devolver(int $numSoporte): bool {
        // Se pasa como argumento en numero del soporte a devolver
        // que utilizaremos para buscarlo en el array de soportes alquilados
        // que resulta un array asociativo con los soportes alquilados
